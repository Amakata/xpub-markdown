class Xpub::Markdown::Parser
  ...
  module ::Xpub::MarkdownConstruction
    def block_quote(compiler, position, content)
      ::Xpub::Markdown::BlockQuoteNode.new(compiler, position, content)
    end
    def bullet_list(compiler, position, content)
      ::Xpub::Markdown::BulletListNode.new(compiler, position, content)
    end
    def bullet_list_item(compiler, position, content)
      ::Xpub::Markdown::BulletListItemNode.new(compiler, position, content)
    end
    def document(compiler, position, content)
      ::Xpub::Markdown::DocumentNode.new(compiler, position, content)
    end
    def headline(compiler, position, level, content)
      ::Xpub::Markdown::HeadlineNode.new(compiler, position, level, content)
    end
    def horizontal_rule(compiler, position)
      ::Xpub::Markdown::HorizontalRuleNode.new(compiler, position)
    end
    def inline_element(compiler, position, name, content)
      ::Xpub::Markdown::InlineElementNode.new(compiler, position, name, content)
    end
    def linebreak(compiler, position)
      ::Xpub::Markdown::LineBreakNode.new(compiler, position)
    end
    ...
    def verbatim(compiler, position, content)
      ::Xpub::Markdown::VerbatimNode.new(compiler, position, content)
    end
  end
  include ::Xpub::MarkdownConstruction
